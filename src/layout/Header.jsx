    ...
    <>
      <header className="bg-white border shadow-md p-2 flex justify-between sticky top-0">
        ...
        <Link to="/" className="flex items-center">
          <div className="font-bold text-xl cursor-pointer mx-24">Record Of Music</div>
        </Link>

        <div className="flex font-semibold text-md items-center justify-center hover:bg-green-300 rounded-md cursor-pointer">
          <div>
            <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="user"className="w-10 border rounded-full" />
          </div>
